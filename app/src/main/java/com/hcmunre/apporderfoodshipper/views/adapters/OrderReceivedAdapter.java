...
public class OrderReceivedAdapter extends RecyclerView.Adapter<OrderReceivedAdapter.ViewHolder> {
    ...
    public OrderReceivedAdapter(Context context, ArrayList<ShipperOrder> shipperOrders) {
    ...
    @Override
    public void onBindViewHolder(@NonNull OrderReceivedAdapter.ViewHolder holder, final int position) {
